...
class Envira_Albums_Metaboxes {
    ...
    public function admin_styles() {
        ...
        wp_register_style( $this->base->plugin_slug . '-albums-admin-style', plugins_url( 'assets/css/albums-admin.css', $this->base->file ), array(), $this->base->version );
        wp_enqueue_style( $this->base->plugin_slug . '-albums-admin-style' );
        ...
        <p class="envira-intro">
            ...
            <small>
                <?php if ( apply_filters('envira_whitelabel', false )  ): ?>
                    ...
                    <?php _e( 'Displaying the most recent galleries. Please use the search box to display all matching galleries.', 'envira-albums' ); ?>
    ...
    */
            ...
            <div id="envira-config-description-settings-box">
                <table class="form-table no-bottom-margin">
                    ...
                    <tr id="envira-config-lazy-loading-box">
                        ...
                        <td>
                            <input id="envira-config-lazy-loading" type="checkbox" name="_eg_album_data[config][lazy_loading]" value="<?php echo $this->get_config( 'lazy_loading', $this->get_config_default( 'lazy_loading' ) ); ?>" <?php checked( $this->get_config( 'lazy_loading', $this->get_config_default( 'lazy_loading' ) ), 1 ); ?> />
                    ...
                    <tr id="envira-config-lazy-loading-box">
                        ...
                        <td>
                            <input id="envira-config-lazy-loading" type="checkbox" name="_eg_album_data[config][lazy_loading]" value="<?php echo $this->get_config( 'lazy_loading', $this->get_config_default( 'lazy_loading' ) ); ?>" <?php checked( $this->get_config( 'lazy_loading' ), 1 ); ?> />
                            <span class="description"><?php _e( 'Enables or disables lazy loading, which helps with performance by loading thumbnails only when they are visible. See our documentation for more information.', 'envira-gallery' ); ?></span>
                        </td>
                    </tr>
                    ...
                    <tr id="envira-config-lazy-loading-delay">
                        <th scope="row">
                            ...
                            <td>
                                <input id="envira-config-lazy-loading-delay" type="number" name="_eg_album_data[config][lazy_loading_delay]" value="<?php echo $this->get_config( 'lazy_loading_delay', $this->get_config_default( 'lazy_loading_delay' ) ); ?>" /> <span class="envira-unit"><?php _e( 'milliseconds', 'envira-gallery' ); ?></span>
                    ...
                    <?php /* <tr id="envira-config-album-title-automattic-box">
                        <th scope="row">
                ...
                <table class="form-table" style="margin-bottom: 0;">
                    ...
                    <tr id="envira-config-title-box">
                        ...
                        <td>
                            ...
                            <p class="description"><?php _e( 'Choose to display an image title above or below the gallery image for column layouts. For automatic layouts, the title will appear in the image caption on hover.', 'envira-albums' ); ?></p>
                        </td>
                ...
                <table class="form-table">
                    ...
                    <tr id="envira-config-caption-box">
                        ...
                        <td>
                            ...
                            <span class="description"><?php _e( 'Displays gallery captions. For automatic layouts, the caption will appear in the image caption on hover. For column layouts, this will be below each gallery image.', 'envira-albums' ); ?></span>
                        </td>
                    </tr>
                    ...
                    <tr id="envira-config-gallery-description">
                        <th scope="row">
                            <label for="envira-config-gallery-description"><?php _e( 'Display Gallery Descriptions?', 'envira-gallery' ); ?></label>
                        </th>
                        <td>
                            <select id="envira-config-gallery-description" name="_eg_album_data[config][gallery_description_display]">
                                <?php foreach ( (array) $this->get_gallery_description_options() as $i => $data ) : ?>
                                    <option value="<?php echo $i; ?>"<?php selected( $i, $this->get_config( 'gallery_description_display', $this->get_config_default( 'gallery_description_display' ) ) ); ?>><?php echo $data; ?></option>
                                <?php endforeach; ?>
                            </select>
                            <p class="description"><?php _e( 'Allows you to display gallery description. For automatic layouts, the description overrides the image caption.', 'envira-albums' ); ?></p>
                        </td>
                    </tr>
                    ...
                    <tr id="envira-config-image-count-box">
                        ...
                        <td>
                            ...
                            <span class="description"><?php _e( 'Displays the number of images in each gallery below each gallery image. For automatic layouts, the count will be appended to the image caption.', 'envira-albums' ); ?></span>
                        </td>
                    </tr>
            ...
            <table class="form-table">
                <tbody>
                    ...
                    <tr id="envira-config-mobile-touchwipe-box">
                        <th scope="row">
                            <label for="envira-config-mobile-touchwipe"><?php _e( 'Enable Gallery Touchswipe?', 'envira-albums' ); ?></label>
                        </th>
                        <td>
                            ...
                            <span class="description"><?php _e( 'Enables or disables touchswipe support for the gallery lightbox on mobile devices.', 'envira-albums' ); ?></span>
                        </td>
                    </tr>
    ...
    /**
     * Helper method for retrieving gallery description settings.
     *
     * @since 1.1.1
     *
     * @return array Array of gallery theme data.
    ...
    public function get_gallery_description_options() {
        ...
        $instance = Envira_Albums_Common::get_instance();
        return $instance->get_gallery_description_options();
    ...
    public function save_meta_boxes( $post_id, $post ) {
        ...
        $settings['config']['css_opacity']          = absint( $_POST['_eg_album_data']['config']['css_opacity'] );
